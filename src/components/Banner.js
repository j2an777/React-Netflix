                ...
                >
                    ...
                    <div className='banner_contents'>
                        ...
                        <div className='banner_buttons'>
                            <button className='banner_button play' onClick={handlePlayClick}>Play</button>
                    ...
                    <Container>
                        <HomeContainer>
                            <Iframe
                                ...
                                ?controls=0&autoplay=1&loop=1&mute=1&playlist=${videoKey}`}
                                width="640"
                                height="360"
                                frameborder="0"
